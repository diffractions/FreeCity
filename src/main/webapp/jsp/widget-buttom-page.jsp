		...
		<div class="row">
			...
			<div class="one-third-block">
				<div class="connect-widget widget">
					<a href="https://danimist.org.ua/uk/projekt/freecity">
					<h6	class="widget-title">Підтримати проект</h6>
						<p>Проект бере участь у конкурсі міських сервісів на основі
							відкритих данних "Apps4Cities/Дані міст"</p> <img src="logo_ukr.png">
					</a>
				</div>
			</div>
			...
			<tr> <td><a class="more button" href="<%@ include file="href-path.jspf"%>list?section=100" style="width: 100%; margin: 0 auto; text-align: center;">Перейти в розділ подій</a></td></tr>
			<tr> <td><a class="more button" href="<%@ include file="href-path.jspf"%>list?section=101" style="width: 100%; margin: 0 auto; text-align: center;">Перейти в розділ місць</a></td></tr>
			<tr> <td><a class="more button" href="<%@ include file="href-path.jspf"%>list?section=102" style="width: 100%; margin: 0 auto; text-align: center;">Перейти в розділ послуг</a></td></tr>
		 
	</table>
<!-- 					<div class="mailing-list"> -->
<!-- 						<h4 class="widget-title">Join our Mailing List</h4> -->
<!-- 						<p>Lorem ipsum dolor sit amet, orci a faucpsum dolor sit amet, orci a faucpsum dolor sit amet, orci a faucpsum dolor sit amet, orci a faucpsum dolor sit amet, orci a faucpsum dolor sit amet, orci a faucpsum dolor sit amet, orci a faucpsum dolor sit amet, orci a faucpsum dolor sit amet, orci a faucpsum dolor sit amet, orci a faucpsum dolor sit amet, orci a faucpsum dolor sit amet, orci a faucpsum dolor sit amet, orci a faucpsum dolor sit amet, orci a faucpsum dolor sit amet, orci a faucpsum dolor sit amet, orci a faucibus, ante curabitur -->
<!-- 							augue</p> -->
...
<!-- 				<div class="connect-widget widget"> -->
<!-- 					<div class="mailing-list"> -->
<!-- 						<h4 class="widget-title">Підписатися на розсилку</h4> -->
<!-- 						<p>Ви отримуватимете на електронну адресу повідомлення про безкоштовні заходи у вашому місті.</p> -->
<!-- 						<form class="widget-form" action="subscribe" method="get"> -->
<!-- 							<label> <span class="screen-reader-text">Join our -->
<!-- 									mailing list for news and exclusive offers:</span> <input type="email" -->
<!-- 								class="email-field" placeholder="Enter your email address" -->
<!-- 								value="" name="email" title="Enter your email address" /> -->
...
<!-- <!-- 					.mailing-list -->
<!-- 					<div class="social-icons"> -->
<!-- 						<h4 class="widget-title">Стежити за нами</h4> -->
<!-- 						<p>Ви також можете переглянути всі оновлення на сайті через соціальні мережі:</p> -->
<!-- 						<ul class="horizontal-navigation"> -->
<!-- 							<li class="facebook"><a href="#" title="Facebook" -->
<!-- 								target="_blank"><i class="fa fa-facebook fa-2x fa-fw"></i></a></li> -->
<!-- 							<li class="twitter"><a href="#" title="Twitter" -->
